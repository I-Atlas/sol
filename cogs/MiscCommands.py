...
class MiscCommands(commands.Cog):
    ...
    @commands.command(name='color', aliases=['rc'], pass_context=True)
    ...
    @commands.command(name='say', aliases=['s'], pass_context=True)
    ...
    @commands.command(name='game', aliases=['g'], pass_context=True)
    @commands.has_permissions()
